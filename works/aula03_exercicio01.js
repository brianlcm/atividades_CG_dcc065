function main()
{
  ...
  function changeCamera() {
    ...
    secondaryMsg.changeMessage(`Up : ${up.x.toFixed(1)} ${up.y.toFixed(1)} ${up.z.toFixed(1)} 
                                Position : ${posicao.x.toFixed(1)} ${posicao.y.toFixed(1)} ${posicao.z.toFixed(1)} 
                                Point: ${aponta.x.toFixed(1)} ${aponta.y.toFixed(1)} ${aponta.z.toFixed(1)}`)
